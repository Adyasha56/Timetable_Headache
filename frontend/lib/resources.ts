  ...
  sections: {
    ...
    fields: [
      ...
      },
      {
        ...
        optionLabelFormat: (item) => `${item.year as number} Sem ${item.semester as number}`,
        placeholder: "Select semester",
      },
      { key: "year", label: "Year of Study", type: "number", placeholder: "1" },
  ...
  calendars: {
    ...
    fields: [
      { key: "year", label: "Academic Year", type: "number", placeholder: "2026" },
      {
        ...
        type: "select",
        options: [
          { label: "Semester 1 (Odd)", value: "1" },
          { label: "Semester 2 (Even)", value: "2" },
        ],
        placeholder: "Select semester",
      },
